...
export const metadata = pageMetadata({ title: "Service Areas", description: "Doorstep appliance repair in Faridabad, Ballabhgarh, South Delhi, Noida, Greater Noida, Gurugram and Ghaziabad." });
